...
- (nullable byref id<GlkStream>) createReadOnlyStream;
/// Creates a write only stream from this fileref.
- (nullable byref id<GlkStream>) createWriteOnlyStream;
/// Creates a read/write stream from this fileref.
- (nullable byref id<GlkStream>) createReadWriteStream;
...
@optional
/// The file used to create the file.
- (nullable bycopy NSURL *)fileURL;
